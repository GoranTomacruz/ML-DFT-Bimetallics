...
files = ['Mono_Valence Electrons vs C-adsorption energy']
files_cu = ['Cu_Valence Electrons vs C-adsorption energy']
files_pt = ['Pt_Valence Electrons vs C-adsorption energy']
...
for file in files:
    ...
    ax.set_title("Valence Electrons vs {}-Adsorption Energy for {}".format(atom[i], material), fontsize=16)
